...
```sh
nix profile install \
  github:neodymium6/agent-knowledge/v0.6.0#agent-knowledge
...
```text
ghcr.io/neodymium6/agent-knowledge-worker:0.6.0
ghcr.io/neodymium6/agent-knowledge-queue-ingress:0.6.0
ghcr.io/neodymium6/agent-knowledge-gateway:0.6.0
ghcr.io/neodymium6/agent-knowledge-openssh-gateway:0.6.0
ghcr.io/neodymium6/agent-knowledge-storage-bootstrap:0.6.0
ghcr.io/neodymium6/agent-knowledge-client-mcp:0.6.0
```
...
- name: agent-knowledge-mcp
  image: ghcr.io/neodymium6/agent-knowledge-client-mcp:0.6.0
  args:
    - --destination
    - fictional-knowledge
    - --listen
