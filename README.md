...
```sh
nix profile install \
  github:neodymium6/agent-knowledge/v0.3.0#agent-knowledge
...
```text
ghcr.io/neodymium6/agent-knowledge-worker:0.3.0
ghcr.io/neodymium6/agent-knowledge-queue-ingress:0.3.0
ghcr.io/neodymium6/agent-knowledge-gateway:0.3.0
ghcr.io/neodymium6/agent-knowledge-openssh-gateway:0.3.0
ghcr.io/neodymium6/agent-knowledge-storage-bootstrap:0.3.0
ghcr.io/neodymium6/agent-knowledge-client-mcp:0.3.0
```
...
Additional read tools provide search excerpts and bounded project context:
...
The corresponding MCP tools are `knowledge_search_excerpts` and `knowledge_context`.
...
- name: agent-knowledge-mcp
  image: ghcr.io/neodymium6/agent-knowledge-client-mcp:0.3.0
  args:
    - --destination
    - fictional-knowledge
    - --listen
